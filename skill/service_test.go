...
import (
	...
	"github.com/cloudwego/eino/compose/blueprint"
...
type skillDocumentLoaderAdapter struct {
	...
	docLoader   blueprint.DocumentLoader
}
...
func (a skillDocumentLoaderAdapter) LoadGraphBlueprint(ctx context.Context, target string) (*schemad.GraphBlueprint, error) {
	if a.docLoader == nil {
